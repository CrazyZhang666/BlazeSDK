...
public class UserSessionExtendedData : Tdf
{
    static readonly TdfMemberInfo[] __typeInfos = [
        ...
        new TdfMemberInfo("LatencyList", "mLatencyList", 0xC33B2D00, TdfType.List, 6, true), // PSLM
        new TdfMemberInfo("QosData", "mQosData", 0xC6487400, TdfType.Struct, 7, true), // QDAT
        new TdfMemberInfo("UserInfoAttribute", "mUserInfoAttribute", 0xD61D3400, TdfType.UInt64, 8, true), // UATT
        new TdfMemberInfo("BlazeObjectIdList", "mBlazeObjectIdList", 0xD6CCF400, TdfType.List, 9, true), // ULST
    ];
    private ITdfMember[] __members;

    private TdfUnion<Blaze2SDK.Blaze.NetworkAddress> _address = new(__typeInfos[0]);
    ...
    private TdfMap<uint, int> _dataMap = new(__typeInfos[4]);
    private TdfEnum<Blaze2SDK.Blaze.HardwareFlags> _hardwareFlags = new(__typeInfos[5]);
    ...
    public Blaze2SDK.Blaze.NetworkAddress Address
    {
        get => _address.Value;
    ...
    public IDictionary<uint, int> DataMap
    {
        get => _dataMap.Value;
    ...
    public Blaze2SDK.Blaze.Util.NetworkQosData? QosData
    {
        get => _qosData.Value;
