...
public class ServerMessage : Tdf
{
    ...
    private TdfEnum<Blaze2SDK.Blaze.Messaging.ServerFlags> _flags = new(__typeInfos[0]);
    ...
    public Blaze2SDK.Blaze.Messaging.ServerFlags Flags
    {
        get => _flags.Value;
    ...
    public Blaze2SDK.Blaze.Messaging.ClientMessage? Payload
    {
        get => _payload.Value;
